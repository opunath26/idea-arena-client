        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="px-3 py-2 pl-10 border rounded-md focus:ring-purple-500 w-full"
              />
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="px-3 py-2 border rounded-md focus:ring-purple-500 w-full"
            ></textarea>
          </div>
          ...
          <div className="mt-8">
            <button
              type="button"
              className="bg-purple-600 hover:bg-purple-700 py-3 rounded-md w-full text-white text-lg transition"
            >
              Submit Contest
            </button>
          </div>
