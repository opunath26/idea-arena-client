    ...
    return (
        <div>
            <section className="relative bg-gradient-to-b from-gray-50 to-white py-24 overflow-hidden">
                {/* Background Decor */}
                <div className="top-0 right-0 absolute bg-purple-100/50 blur-3xl rounded-full w-96 h-96 -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                <div className="bottom-0 left-0 absolute bg-indigo-50/50 blur-3xl rounded-full w-96 h-96 -translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
                ...
                <div className="relative mx-auto px-4 container">
                    ...
                    <div className="mb-16 text-center">
                        ...
                        <h2 className="mb-4 font-black text-gray-900 text-4xl md:text-5xl tracking-tight">
                            Recent Innovation <span className="bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600 text-transparent">Contests</span>
                        </h2>
